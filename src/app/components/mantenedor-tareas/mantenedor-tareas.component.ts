...
@Component({
  selector: 'app-mantenedor-tareas',
  templateUrl: './mantenedor-tareas.component.html',
  styleUrls: ['./mantenedor-tareas.component.css']
})
export class MantenedorTareasComponent implements OnInit {
